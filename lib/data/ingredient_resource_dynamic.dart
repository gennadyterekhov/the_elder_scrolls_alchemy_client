...
class IngredientResourceDynamic {
  IngredientResourceDynamic(gameName) {
    currentMap = DataSourceDynamic.byGame(gameName).getMap()['ingredients'];
  }

  String gameName = '';
  Map<String, dynamic> currentMap = {};

  factory IngredientResourceDynamic.byGame(String gameName) {
    return IngredientResourceDynamic(gameName);
  }
